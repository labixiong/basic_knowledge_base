...
function Discuss(props) {
	...
	function handleSubmit() {
		...
		// 评论成功增加积分以及评论数量的变化
		updateIssue(props.targetId, { commentNumber: props.issueInfo ? props.issueInfo.commentNumber + 1 : props.bookInfo.commentNumber + 1 })
			...
			{/* 分页 */}
			{
				commentList.length > 0 ? (
					<div className={styles.paginationContainer}>
						<Pagination showQuickJumper total={pageInfo.total} defaultCurrent={1}></Pagination>
					</div>
				) : (
