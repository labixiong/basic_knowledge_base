...
export async function getRoutes() {
  const routes = {"1":{"path":"/","redirect":"/home","parentId":"ant-design-pro-layout","id":"1"},"2":{"name":"首页","path":"/home","icon":"HomeOutlined","parentId":"ant-design-pro-layout","id":"2"},"3":{"name":"管理员","path":"/admin","icon":"UserOutlined","parentId":"ant-design-pro-layout","id":"3"},"4":{"path":"adminList","name":"管理员列表","parentId":"3","id":"4"},"5":{"path":"addAdmin","name":"添加管理员","parentId":"3","id":"5"},"6":{"name":"用户","path":"/user","icon":"TeamOutlined","parentId":"ant-design-pro-layout","id":"6"},"7":{"path":"userList","name":"用户列表","parentId":"6","id":"7"},"8":{"path":"addUser","name":"添加用户","parentId":"6","id":"8"},"9":{"name":"书籍","path":"/book","icon":"ReadOutlined","parentId":"ant-design-pro-layout","id":"9"},"10":{"path":"bookList","name":"书籍列表","parentId":"9","id":"10"},"11":{"path":"addBook","name":"添加书籍","parentId":"9","id":"11"},"12":{"name":"面试题","path":"/interview","icon":"EditOutlined","parentId":"ant-design-pro-layout","id":"12"},"13":{"name":"问答","path":"/issue","icon":"ProfileOutlined","parentId":"ant-design-pro-layout","id":"13"},"14":{"name":"评论","path":"/comment","icon":"CalendarOutlined","parentId":"ant-design-pro-layout","id":"14"},"15":{"name":"类型","path":"/type","icon":"AppstoreOutlined","parentId":"ant-design-pro-layout","id":"15"},"ant-design-pro-layout":{"id":"ant-design-pro-layout","path":"/","isLayout":true}} as const;
  return {
    routes,
    routeComponents: {
...
'ant-design-pro-layout': React.lazy(() => import(/* webpackChunkName: "umi__plugin-layout__Layout" */'D:/code/github/basic_knowledge_base/code-station/backend/src/.umi/plugin-layout/Layout.tsx')),
},
  };
}
